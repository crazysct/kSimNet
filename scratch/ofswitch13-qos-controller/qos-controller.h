...
#ifndef QOS_CONTROLLER_H1
#define QOS_CONTROLLER_H1
 ...
 */
class QosController1 : public OFSwitch13Controller
{
public:
  QosController1 ();          //!< Default constructor.
  virtual ~QosController1 (); //!< Dummy destructor.
