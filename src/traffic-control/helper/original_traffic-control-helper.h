...
public:
   ...
   */
  static TrafficControlHelper1 Default (void);
   ...
   * of the devices.
   */
  QueueDiscContainer Install (NetDeviceContainer1 c);
   ...
   */
  QueueDiscContainer Install (Ptr<NetDevice1> d);
   ...
   */
  void Uninstall (NetDeviceContainer1 c);
   ...
   */
  void Uninstall (Ptr<NetDevice1> d);
