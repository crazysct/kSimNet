...
#include "original_traffic-control-helper.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("TrafficControlHelper1");
...
TrafficControlHelper1::TrafficControlHelper1 ()
{
}

TrafficControlHelper1
TrafficControlHelper1::Default (void)
{
  TrafficControlHelper1 helper;
  helper.SetRootQueueDisc ("ns3::PfifoFastQueueDisc");
  return helper;
}

uint16_t
TrafficControlHelper1::SetRootQueueDisc (std::string type,
...
void
TrafficControlHelper1::AddInternalQueues (uint16_t handle, uint16_t count, std::string type,
                                         std::string n01, const AttributeValue& v01,
                                         std::string n02, const AttributeValue& v02,
                                         std::string n03, const AttributeValue& v03,
                                         std::string n04, const AttributeValue& v04,
...
void
TrafficControlHelper1::AddPacketFilter (uint16_t handle, std::string type,
                                       std::string n01, const AttributeValue& v01,
                                       std::string n02, const AttributeValue& v02,
                                       std::string n03, const AttributeValue& v03,
                                       std::string n04, const AttributeValue& v04,
...
TrafficControlHelper1::ClassIdList
TrafficControlHelper1::AddQueueDiscClasses (uint16_t handle, uint16_t count, std::string type,
                                           std::string n01, const AttributeValue& v01,
                                           std::string n02, const AttributeValue& v02,
                                           std::string n03, const AttributeValue& v03,
                                           std::string n04, const AttributeValue& v04,
...
uint16_t
TrafficControlHelper1::AddChildQueueDisc (uint16_t handle, uint16_t classId, std::string type,
                                         std::string n01, const AttributeValue& v01,
                                         std::string n02, const AttributeValue& v02,
                                         std::string n03, const AttributeValue& v03,
                                         std::string n04, const AttributeValue& v04,
...
TrafficControlHelper1::HandleList
TrafficControlHelper1::AddChildQueueDiscs (uint16_t handle, const TrafficControlHelper1::ClassIdList &classes,
                                          std::string type,
                                          std::string n01, const AttributeValue& v01,
                                          std::string n02, const AttributeValue& v02,
                                          std::string n03, const AttributeValue& v03,
...
void
TrafficControlHelper1::SetQueueLimits (std::string type,
                                      std::string n01, const AttributeValue& v01,
                                      std::string n02, const AttributeValue& v02,
                                      std::string n03, const AttributeValue& v03,
                                      std::string n04, const AttributeValue& v04,
...
QueueDiscContainer
TrafficControlHelper1::Install (Ptr<NetDevice1> d)
{
...
QueueDiscContainer
TrafficControlHelper1::Install (NetDeviceContainer1 c)
{
  QueueDiscContainer container;
...
void
TrafficControlHelper1::Uninstall (Ptr<NetDevice1> d)
{
  Ptr<TrafficControlLayer> tc = d->GetNode ()->GetObject<TrafficControlLayer> ();
  NS_ASSERT (tc != 0);
...
void
TrafficControlHelper1::Uninstall (NetDeviceContainer1 c)
{
  for (NetDeviceContainer1::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      Uninstall (*i);
