...
NS_LOG_COMPONENT_DEFINE ("NrFrStrictAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (NrFrStrictAlgorithm);
...
NrFrStrictAlgorithm::NrFrStrictAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0),
    ...
    m_measId (0)
{
  ...
  m_ffrSapProvider = new MemberNrFfrSapProvider<NrFrStrictAlgorithm> (this);
  m_ffrRrcSapProvider = new MemberNrFfrRrcSapProvider<NrFrStrictAlgorithm> (this);
}
...
NrFrStrictAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::NrFrStrictAlgorithm")
    ...
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&NrFrStrictAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NrFrStrictAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
  ;
  return tid;
}
...
void
NrFrStrictAlgorithm::SetNrFfrSapUser (NrFfrSapUser* s)
{
...
NrFfrSapProvider*
NrFrStrictAlgorithm::GetNrFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrStrictAlgorithm::SetNrFfrRrcSapUser (NrFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
NrFfrRrcSapProvider*
NrFrStrictAlgorithm::GetNrFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrStrictAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrStrictAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
NrFrStrictAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
NrFrStrictAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
NrFrStrictAlgorithm::InitializeDownlinkRbgMaps ()
{
  m_dlRbgMap.clear ();
...
void
NrFrStrictAlgorithm::InitializeUplinkRbgMaps ()
{
  m_ulRbgMap.clear ();
...
std::vector <bool>
NrFrStrictAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFrStrictAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
NrFrStrictAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFrStrictAlgorithm::DoIsUlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
NrFrStrictAlgorithm::DoReportUlCqiInfo (std::map <uint16_t, std::vector <double> > ulCqiMap)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
uint8_t
NrFrStrictAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
NrFrStrictAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrStrictAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
NrFrStrictAlgorithm::DoRecvLoadInformation (NgcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
