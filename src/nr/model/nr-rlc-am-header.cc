...
NS_LOG_COMPONENT_DEFINE ("NrRlcAmHeader");
...
void
NrRlcAmHeader::SetDataPdu (void)
{
  m_headerLength = 4;
  m_dataControlBit = DATA_PDU;
}
void
NrRlcAmHeader::SetControlPdu (uint8_t controlPduType)
{
  m_headerLength = 2;
...
bool
NrRlcAmHeader::IsDataPdu (void) const
{
  return (m_dataControlBit == DATA_PDU) ? true : false;
}
bool
NrRlcAmHeader::IsControlPdu (void) const
{
  return (m_dataControlBit == CONTROL_PDU) ? true : false;
}

void
NrRlcAmHeader::SetFramingInfo (uint8_t framingInfo)
{
  m_framingInfo = framingInfo & 0x03;
}

void
NrRlcAmHeader::SetSequenceNumber (SequenceNumber10 sequenceNumber)
{
  m_sequenceNumber = sequenceNumber;
}

uint8_t
NrRlcAmHeader::GetFramingInfo () const
{
...
void
NrRlcAmHeader::PushExtensionBit (uint8_t extensionBit)
{
...
void
NrRlcAmHeader::PushLengthIndicator (uint16_t lengthIndicator)
{
...
uint8_t
NrRlcAmHeader::PopExtensionBit (void)
{
...
uint16_t
NrRlcAmHeader::PopLengthIndicator (void)
{
...
void
NrRlcAmHeader::SetResegmentationFlag (uint8_t resegFlag)
{
  m_resegmentationFlag = resegFlag & 0x01;
}

uint8_t
NrRlcAmHeader::GetResegmentationFlag () const
{
...
void
NrRlcAmHeader::SetPollingBit (uint8_t pollingBit)
{
  m_pollingBit = pollingBit & 0x01;
}

uint8_t
NrRlcAmHeader::GetPollingBit (void) const
{
  return m_pollingBit;
}
...
void
NrRlcAmHeader::SetLastSegmentFlag (uint8_t lsf)
{
  m_lastSegmentFlag = lsf & 0x01;
}

uint8_t
NrRlcAmHeader::GetLastSegmentFlag (void) const
{
...
void
NrRlcAmHeader::SetSegmentOffset (uint16_t segmentOffset)
{
  m_segmentOffset = segmentOffset & 0x7FFF;
}

uint16_t
NrRlcAmHeader::GetSegmentOffset (void) const
{
  return m_segmentOffset;
}

uint16_t
NrRlcAmHeader::GetLastOffset (void) const
{
  return m_lastOffset;
}
...
void
NrRlcAmHeader::SetAckSn (SequenceNumber10 ackSn)
{
  m_ackSn = ackSn;
}

bool
NrRlcAmHeader::OneMoreNackWouldFitIn (uint16_t bytes)
{
...
void
NrRlcAmHeader::PushNack (int nack)
{
...
bool
NrRlcAmHeader::IsNackPresent (SequenceNumber10 nack)
{
...
SequenceNumber10
NrRlcAmHeader::GetAckSn (void) const
{
  return m_ackSn;
}
...
uint32_t NrRlcAmHeader::GetSerializedSize (void) const
{
  return m_headerLength;
}

void NrRlcAmHeader::Serialize (Buffer::Iterator start) const
{
...
uint32_t NrRlcAmHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  uint8_t byte_1;
  uint8_t byte_2;
