...
NS_LOG_COMPONENT_DEFINE ("NrFfrEnhancedAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (NrFfrEnhancedAlgorithm);
...
NrFfrEnhancedAlgorithm::NrFfrEnhancedAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0),
    m_measId (0)
{
  NS_LOG_FUNCTION (this);
  m_ffrSapProvider = new MemberNrFfrSapProvider<NrFfrEnhancedAlgorithm> (this);
  m_ffrRrcSapProvider = new MemberNrFfrRrcSapProvider<NrFfrEnhancedAlgorithm> (this);
}
...
void
NrFfrEnhancedAlgorithm::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
NrFfrEnhancedAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::NrFfrEnhancedAlgorithm")
    ...
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&NrFfrEnhancedAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NrFfrEnhancedAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
  ;
  return tid;
}
...
void
NrFfrEnhancedAlgorithm::SetNrFfrSapUser (NrFfrSapUser* s)
{
...
NrFfrSapProvider*
NrFfrEnhancedAlgorithm::GetNrFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrEnhancedAlgorithm::SetNrFfrRrcSapUser (NrFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
NrFfrRrcSapProvider*
NrFfrEnhancedAlgorithm::GetNrFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrEnhancedAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrEnhancedAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
NrFfrEnhancedAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrEnhancedAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
int
NrFfrEnhancedAlgorithm::GetCqiFromSpectralEfficiency (double s)
{
  NS_LOG_FUNCTION (s);
...
void
NrFfrEnhancedAlgorithm::InitializeDownlinkRbgMaps ()
{
  m_dlRbgMap.clear ();
...
void
NrFfrEnhancedAlgorithm::InitializeUplinkRbgMaps ()
{
  m_ulRbgMap.clear ();
...
std::vector <bool>
NrFfrEnhancedAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFfrEnhancedAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
NrFfrEnhancedAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFfrEnhancedAlgorithm::DoIsUlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrEnhancedAlgorithm::DoReportUlCqiInfo ( std::map <uint16_t, std::vector <double> > ulCqiMap )
{
  NS_LOG_FUNCTION (this);
...
double
NrFfrEnhancedAlgorithm::EstimateUlSinr (uint16_t rnti, uint16_t rb, std::map <uint16_t, std::vector <double> > ulCqiMap)
{
...
uint8_t
NrFfrEnhancedAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
NrFfrEnhancedAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrEnhancedAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
NrFfrEnhancedAlgorithm::DoRecvLoadInformation (NgcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
