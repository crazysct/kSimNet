...
//NS_OBJECT_ENSURE_REGISTERED (NrHarqPhy)
//  ;
...
void
NrHarqPhy::SubframeIndication (uint32_t frameNo, uint32_t subframeNo)
{
...
double
NrHarqPhy::GetAccumulatedMiDl (uint8_t harqProcId, uint8_t layer)
{
...
NrHarqPhy::GetHarqProcessInfoDl (uint8_t harqProcId, uint8_t layer)
{
  NS_LOG_FUNCTION (this << (uint32_t)harqProcId << (uint16_t)layer);
...
double
NrHarqPhy::GetAccumulatedMiUl (uint16_t rnti)
{
...
void
NrHarqPhy::UpdateDlHarqProcessStatus (uint8_t id, uint8_t layer, double mi, uint16_t infoBytes, uint16_t codeBytes)
{
...
void
NrHarqPhy::ResetDlHarqProcessStatus (uint8_t id)
{
...
void
NrHarqPhy::UpdateUlHarqProcessStatus (uint16_t rnti, double mi, uint16_t infoBytes, uint16_t codeBytes)
{
