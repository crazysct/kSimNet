...
void
NrRlcHeader::SetFramingInfo (uint8_t framingInfo)
{
  m_framingInfo = framingInfo & 0x03;
}

void
NrRlcHeader::SetSequenceNumber (SequenceNumber10 sequenceNumber)
{
  m_sequenceNumber = sequenceNumber;
}

uint8_t
NrRlcHeader::GetFramingInfo () const
{
  return m_framingInfo;
}

SequenceNumber10
NrRlcHeader::GetSequenceNumber () const
{
...
void
NrRlcHeader::PushExtensionBit (uint8_t extensionBit)
{
...
void
NrRlcHeader::PushLengthIndicator (uint16_t lengthIndicator)
{
...
uint8_t
NrRlcHeader::PopExtensionBit (void)
{
...
uint16_t
NrRlcHeader::PopLengthIndicator (void)
{
...
TypeId
NrRlcHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NrRlcHeader")
    .SetParent<Header> ()
    .SetGroupName("Nr")
...
TypeId
NrRlcHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
...
void NrRlcHeader::Serialize (Buffer::Iterator start) const
{
...
uint32_t NrRlcHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  uint8_t byte_1;
  uint8_t byte_2;
