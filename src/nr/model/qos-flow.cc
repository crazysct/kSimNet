...
QosFlow::QosFlow (Qci x)
  : qci (x)
{
}

QosFlow::QosFlow (Qci x, struct GbrQosInformation y)
  : qci (x), gbrQosInfo (y)
{
}
...
uint16_t
QosFlow::GetPacketDelayBudgetMs () const
{
  // 3GPP 23.203 Section 6.1.7.2
  switch (qci)
    {
...
double
QosFlow::GetPacketErrorLossRate () const
{
  // 3GPP 23.203 Section 6.1.7.2
  switch (qci)
    {
