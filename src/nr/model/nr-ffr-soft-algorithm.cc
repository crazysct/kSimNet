...
NS_LOG_COMPONENT_DEFINE ("NrFfrSoftAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (NrFfrSoftAlgorithm);
...
NrFfrSoftAlgorithm::NrFfrSoftAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0),
    ...
    m_measId (0)
{
  ...
  m_ffrSapProvider = new MemberNrFfrSapProvider<NrFfrSoftAlgorithm> (this);
  m_ffrRrcSapProvider = new MemberNrFfrRrcSapProvider<NrFfrSoftAlgorithm> (this);
}
...
NrFfrSoftAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::NrFfrSoftAlgorithm")
    ...
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&NrFfrSoftAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("MediumAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NrFfrSoftAlgorithm::m_mediumAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NrFfrSoftAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
  ;
  return tid;
}
...
void
NrFfrSoftAlgorithm::SetNrFfrSapUser (NrFfrSapUser* s)
{
...
NrFfrSapProvider*
NrFfrSoftAlgorithm::GetNrFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::SetNrFfrRrcSapUser (NrFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
NrFfrRrcSapProvider*
NrFfrSoftAlgorithm::GetNrFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
NrFfrSoftAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::InitializeDownlinkRbgMaps ()
{
  m_dlRbgMap.clear ();
...
void
NrFfrSoftAlgorithm::InitializeUplinkRbgMaps ()
{
  m_ulRbgMap.clear ();
...
std::vector <bool>
NrFfrSoftAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFfrSoftAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
NrFfrSoftAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFfrSoftAlgorithm::DoIsUlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::DoReportDlCqiInfo (const struct NrFfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::DoReportUlCqiInfo (const struct NrFfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
void
NrFfrSoftAlgorithm::DoReportUlCqiInfo (std::map <uint16_t, std::vector <double> > ulCqiMap)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
uint8_t
NrFfrSoftAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
NrFfrSoftAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFfrSoftAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
NrFfrSoftAlgorithm::DoRecvLoadInformation (NgcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
