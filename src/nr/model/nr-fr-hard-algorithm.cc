...
NS_LOG_COMPONENT_DEFINE ("NrFrHardAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (NrFrHardAlgorithm);
...
NrFrHardAlgorithm::NrFrHardAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0),
    m_dlOffset (0),
    m_dlSubBand (0),
    ...
    m_ulSubBand (0)
{
  ...
  m_ffrSapProvider = new MemberNrFfrSapProvider<NrFrHardAlgorithm> (this);
  m_ffrRrcSapProvider = new MemberNrFfrRrcSapProvider<NrFrHardAlgorithm> (this);
}
...
void
NrFrHardAlgorithm::SetNrFfrSapUser (NrFfrSapUser* s)
{
...
NrFfrSapProvider*
NrFrHardAlgorithm::GetNrFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::SetNrFfrRrcSapUser (NrFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
NrFfrRrcSapProvider*
NrFrHardAlgorithm::GetNrFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::InitializeDownlinkRbgMaps ()
{
  m_dlRbgMap.clear ();
...
void
NrFrHardAlgorithm::InitializeUplinkRbgMaps ()
{
  m_ulRbgMap.clear ();
...
std::vector <bool>
NrFrHardAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFrHardAlgorithm::DoIsDlRbgAvailableForUe (int rbId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
NrFrHardAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NrFrHardAlgorithm::DoIsUlRbgAvailableForUe (int rbId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::DoReportDlCqiInfo (const struct NrFfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::DoReportUlCqiInfo (const struct NrFfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
void
NrFrHardAlgorithm::DoReportUlCqiInfo (std::map <uint16_t, std::vector <double> > ulCqiMap)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
uint8_t
NrFrHardAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
NrFrHardAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
NrFrHardAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
NrFrHardAlgorithm::DoRecvLoadInformation (NgcX2Sap::LoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
