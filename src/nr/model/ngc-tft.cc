...
NS_LOG_COMPONENT_DEFINE ("NgcTft");

std::ostream& operator<< (std::ostream& os, NgcTft::Direction& d)
{
 switch (d)
    {
    case NgcTft::DOWNLINK:
      os << "DOWNLINK";
      break;
    case NgcTft::UPLINK:
      os << "UPLINK";
...
std::ostream& operator<< (std::ostream& os, NgcTft::PacketFilter& f)
{
...
NgcTft::PacketFilter::PacketFilter ()
  : precedence (255),
...
bool 
NgcTft::PacketFilter::Matches (Direction d,
			       Ipv4Address ra, 
			       Ipv4Address la, 
			       uint16_t rp,
			       uint16_t lp,
...
NgcTft::Default ()
{
  ...
  NgcTft::PacketFilter defaultPacketFilter;
...
bool 
NgcTft::Matches (Direction direction,
