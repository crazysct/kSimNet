 ...
 * downlink of an NR FDD system. For instructions on usage, please refer to
...
public:  
  ...
  /** 
   * Deploy the NrRemSpectrumPhy objects that generate the map according to the specified settings.
   * 
   */
  void Install ();
