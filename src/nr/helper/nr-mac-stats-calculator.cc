...
TypeId
NrMacStatsCalculator::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NrMacStatsCalculator")
...
std::string
NrMacStatsCalculator::GetUlOutputFilename (void)
{
...
std::string
NrMacStatsCalculator::GetDlOutputFilename (void)
{
  return NrStatsCalculator::GetDlOutputFilename ();
}

void
NrMacStatsCalculator::DlScheduling (uint16_t cellId, uint64_t imsi, uint32_t frameNo, uint32_t subframeNo,
...
void
NrMacStatsCalculator::UlScheduling (uint16_t cellId, uint64_t imsi, uint32_t frameNo,
...
void
NrMacStatsCalculator::UlSchedulingCallback (Ptr<NrMacStatsCalculator> macStats, std::string path,
