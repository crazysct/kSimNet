...
#ifndef ORIGINAL_NGC_HELPER_H
#define ORIGINAL_NGC_HELPER_H
 ...
 * and connect them. 
 */
class NgcHelper1 : public Object
{
public:
   ...
   */
  virtual void AddEnb (Ptr<Node> enbNode, Ptr<NetDevice1> nrEnbNetDevice, uint16_t cellId) = 0;
   ...
   */
  virtual void AddUe (Ptr<NetDevice1> ueNrDevice, uint64_t imsi) = 0;
   ...
   */
  virtual uint8_t ActivateEpsBearer (Ptr<NetDevice1> ueNrDevice, uint64_t imsi, Ptr<NgcTft> tft, EpsBearer bearer) = 0;
   ...
   * \param bearer struct describing the characteristics of the EPS bearer to be activated
   */
  virtual uint8_t ActivateEpsBearer (Ptr<NetDevice1> ueNrDevice, Ptr<NgcUeNas> ueNas, uint64_t imsi, Ptr<NgcTft> tft, EpsBearer bearer) = 0 ;//sjkang
