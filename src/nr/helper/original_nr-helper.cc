...
NS_LOG_COMPONENT_DEFINE ("NrHelper1");

NS_OBJECT_ENSURE_REGISTERED (NrHelper1);

NrHelper1::NrHelper1 (void)
...
TypeId NrHelper1::GetTypeId (void)
{
  static TypeId
    tid =
    TypeId ("ns3::NrHelper1")
    .SetParent<Object> ()
    .AddConstructor<NrHelper1> ()
    .AddAttribute ("Scheduler",
                   ...
                   MakeStringAccessor (&NrHelper1::SetSchedulerType,
                                       &NrHelper1::GetSchedulerType),
                   MakeStringChecker ())
    .AddAttribute ("FfrAlgorithm",
                   ...
                   MakeStringAccessor (&NrHelper1::SetFfrAlgorithmType,
                                       &NrHelper1::GetFfrAlgorithmType),
                   MakeStringChecker ())
    .AddAttribute ("HandoverAlgorithm",
                   ...
                   MakeStringAccessor (&NrHelper1::SetHandoverAlgorithmType,
                                       &NrHelper1::GetHandoverAlgorithmType),
                   MakeStringChecker ())
    .AddAttribute ("PathlossModel",
                   ...
                   MakeStringAccessor (&NrHelper1::SetPathlossModelType),
                   MakeStringChecker ())
    ...
    .AddAttribute ("UsePdschForCqiGeneration",
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&NrHelper1::m_usePdschForCqiGeneration),
                   MakeBooleanChecker ())
  ;
  return tid;
}
...
void 
NrHelper1::SetNgcHelper (Ptr<NgcHelper1> h)
{
...
void 
NrHelper1::SetSchedulerType (std::string type) 
{
...
std::string
NrHelper1::GetSchedulerType () const
{
  return m_schedulerFactory.GetTypeId ().GetName ();
} 

void 
NrHelper1::SetSchedulerAttribute (std::string n, const AttributeValue &v)
{
...
std::string
NrHelper1::GetFfrAlgorithmType () const
{
  return m_ffrAlgorithmFactory.GetTypeId ().GetName ();
}

void
NrHelper1::SetFfrAlgorithmType (std::string type)
{
  NS_LOG_FUNCTION (this << type);
...
void
NrHelper1::SetFfrAlgorithmAttribute (std::string n, const AttributeValue &v)
{
  NS_LOG_FUNCTION (this << n);
...
std::string
NrHelper1::GetHandoverAlgorithmType () const
{
  return m_handoverAlgorithmFactory.GetTypeId ().GetName ();
}

void
NrHelper1::SetHandoverAlgorithmType (std::string type)
{
  NS_LOG_FUNCTION (this << type);
...
void
NrHelper1::SetHandoverAlgorithmAttribute (std::string n, const AttributeValue &v)
{
  NS_LOG_FUNCTION (this << n);
...
void 
NrHelper1::SetPathlossModelType (std::string type) 
{
  NS_LOG_FUNCTION (this << type);
...
void 
NrHelper1::SetPathlossModelAttribute (std::string n, const AttributeValue &v)
{
  NS_LOG_FUNCTION (this << n);
...
void
NrHelper1::SetEnbDeviceAttribute (std::string n, const AttributeValue &v)
{
  NS_LOG_FUNCTION (this);
...
void 
NrHelper1::SetEnbAntennaModelType (std::string type)
{
  NS_LOG_FUNCTION (this);
...
void 
NrHelper1::SetEnbAntennaModelAttribute (std::string n, const AttributeValue &v)
{
  NS_LOG_FUNCTION (this);
...
void
NrHelper1::SetUeDeviceAttribute (std::string n, const AttributeValue &v)
{
  NS_LOG_FUNCTION (this);
...
void 
NrHelper1::SetUeAntennaModelType (std::string type)
{
  NS_LOG_FUNCTION (this);
...
void 
NrHelper1::SetUeAntennaModelAttribute (std::string n, const AttributeValue &v)
{
  NS_LOG_FUNCTION (this);
...
void 
NrHelper1::SetFadingModel (std::string type) 
{
  NS_LOG_FUNCTION (this << type);
...
void 
NrHelper1::SetFadingModelAttribute (std::string n, const AttributeValue &v)
{
  m_fadingModelFactory.Set (n, v);
}

void 
NrHelper1::SetSpectrumChannelType (std::string type) 
{
  NS_LOG_FUNCTION (this << type);
...
void 
NrHelper1::SetSpectrumChannelAttribute (std::string n, const AttributeValue &v)
{
...
NetDeviceContainer1
NrHelper1::InstallEnbDevice (NodeContainer c)
{
  NS_LOG_FUNCTION (this);
  Initialize ();  // will run DoInitialize () if necessary
  NetDeviceContainer1 devices;
  for (NodeContainer::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      Ptr<Node> node = *i;
      Ptr<NetDevice1> device = InstallSingleEnbDevice (node);
      devices.Add (device);
    }
  return devices;
}
...
NetDeviceContainer1
NrHelper1::InstallUeDevice (NodeContainer c)
{
  NS_LOG_FUNCTION (this);
  NetDeviceContainer1 devices;
  for (NodeContainer::Iterator i = c.Begin (); i != c.End (); ++i)
    {
      Ptr<Node> node = *i;
      Ptr<NetDevice1> device = InstallSingleUeDevice (node);
      devices.Add (device);
    }
  return devices;
}
...
Ptr<NetDevice1>
NrHelper1::InstallSingleEnbDevice (Ptr<Node> n)
{
  ...
  NS_ASSERT_MSG (mm, "MobilityModel needs to be set on node before calling NrHelper1::InstallUeDevice ()");
...
Ptr<NetDevice1>
NrHelper1::InstallSingleUeDevice (Ptr<Node> n)
{
  NS_LOG_FUNCTION (this);
  Ptr<NrSpectrumPhy> dlPhy = CreateObject<NrSpectrumPhy> ();
  Ptr<NrSpectrumPhy> ulPhy = CreateObject<NrSpectrumPhy> ();
...
void
NrHelper1::Attach (NetDeviceContainer1 ueDevices)
{
  NS_LOG_FUNCTION (this);
...
void
NrHelper1::Attach (Ptr<NetDevice1> ueDevice)
{
  NS_LOG_FUNCTION (this);
  ...
  if (ueNrDevice == 0)
    {
      NS_FATAL_ERROR ("The passed NetDevice1 must be an NrUeNetDevice");
    }
...
void
NrHelper1::Attach (NetDeviceContainer1 ueDevices, Ptr<NetDevice1> enbDevice)
{
  NS_LOG_FUNCTION (this);
  for (NetDeviceContainer1::Iterator i = ueDevices.Begin (); i != ueDevices.End (); ++i)
    {
...
void
NrHelper1::Attach (Ptr<NetDevice1> ueDevice, Ptr<NetDevice1> enbDevice)
{
  NS_LOG_FUNCTION (this);
...
void
NrHelper1::AttachToClosestEnb (NetDeviceContainer1 ueDevices, NetDeviceContainer1 enbDevices)
{
  NS_LOG_FUNCTION (this);
  for (NetDeviceContainer1::Iterator i = ueDevices.Begin (); i != ueDevices.End (); ++i)
    {
...
void
NrHelper1::AttachToClosestEnb (Ptr<NetDevice1> ueDevice, NetDeviceContainer1 enbDevices)
{
  NS_LOG_FUNCTION (this);
  NS_ASSERT_MSG (enbDevices.GetN () > 0, "empty enb device container");
  Vector uepos = ueDevice->GetNode ()->GetObject<MobilityModel> ()->GetPosition ();
  double minDistance = std::numeric_limits<double>::infinity ();
  Ptr<NetDevice1> closestEnbDevice;
  for (NetDeviceContainer1::Iterator i = enbDevices.Begin (); i != enbDevices.End (); ++i)
    {
...
uint8_t
NrHelper1::ActivateDedicatedEpsBearer (NetDeviceContainer1 ueDevices, EpsBearer bearer, Ptr<NgcTft> tft)
{
  NS_LOG_FUNCTION (this);
  for (NetDeviceContainer1::Iterator i = ueDevices.Begin (); i != ueDevices.End (); ++i)
    {
...
uint8_t
NrHelper1::ActivateDedicatedEpsBearer (Ptr<NetDevice1> ueDevice, EpsBearer bearer, Ptr<NgcTft> tft)
{
  NS_LOG_FUNCTION (this);
...
public:
  ...
  */
  DrbActivator (Ptr<NetDevice1> ueDevice, EpsBearer bearer);
...
DrbActivator::DrbActivator (Ptr<NetDevice1> ueDevice, EpsBearer bearer)
  : m_active (false),
    m_ueDevice (ueDevice),
    m_bearer (bearer),
...
void 
NrHelper1::ActivateDataRadioBearer (Ptr<NetDevice1> ueDevice, EpsBearer bearer)
{
...
void
NrHelper1::AddX2Interface (NodeContainer enbNodes)
{
  NS_LOG_FUNCTION (this);
...
void
NrHelper1::AddX2Interface (Ptr<Node> enbNode1, Ptr<Node> enbNode2)
{
  NS_LOG_FUNCTION (this);
...
void
NrHelper1::HandoverRequest (Time hoTime, Ptr<NetDevice1> ueDev, Ptr<NetDevice1> sourceEnbDev, Ptr<NetDevice1> targetEnbDev)
{
  NS_LOG_FUNCTION (this << ueDev << sourceEnbDev << targetEnbDev);
  NS_ASSERT_MSG (m_ngcHelper, "Handover requires the use of the NGC - did you forget to call NrHelper1::SetNgcHelper () ?");
  Simulator::Schedule (hoTime, &NrHelper1::DoHandoverRequest, this, ueDev, sourceEnbDev, targetEnbDev);
}

void
NrHelper1::DoHandoverRequest (Ptr<NetDevice1> ueDev, Ptr<NetDevice1> sourceEnbDev, Ptr<NetDevice1> targetEnbDev)
{
  NS_LOG_FUNCTION (this << ueDev << sourceEnbDev << targetEnbDev);
...
void
NrHelper1::DeActivateDedicatedEpsBearer (Ptr<NetDevice1> ueDevice,Ptr<NetDevice1> enbDevice, uint8_t bearerId)
{
...
void
NrHelper1::DoDeActivateDedicatedEpsBearer (Ptr<NetDevice1> ueDevice, Ptr<NetDevice1> enbDevice, uint8_t bearerId)
{
  NS_LOG_FUNCTION (this << ueDevice << bearerId);
...
void 
NrHelper1::ActivateDataRadioBearer (NetDeviceContainer1 ueDevices, EpsBearer bearer)
{
  NS_LOG_FUNCTION (this);
  for (NetDeviceContainer1::Iterator i = ueDevices.Begin (); i != ueDevices.End (); ++i)
    {
...
void
NrHelper1::EnableLogComponents (void)
{
  LogComponentEnable ("NrHelper1", LOG_LEVEL_ALL);
...
void
NrHelper1::EnableRlcTraces (void)
{
  NS_ASSERT_MSG (m_rlcStats == 0, "please make sure that NrHelper1::EnableRlcTraces is called at most once");
  m_rlcStats = CreateObject<NrRadioBearerStatsCalculator> ("RLC");
  m_radioBearerStatsConnector.EnableRlcStats (m_rlcStats);
}

int64_t
NrHelper1::AssignStreams (NetDeviceContainer1 c, int64_t stream)
{
...
void
NrHelper1::EnablePhyTraces (void)
{
  EnableDlPhyTraces ();
  EnableUlPhyTraces ();
  EnableDlTxPhyTraces ();
...
void
NrHelper1::EnableDlTxPhyTraces (void)
{
...
void
NrHelper1::EnableUlTxPhyTraces (void)
{
...
void
NrHelper1::EnableDlRxPhyTraces (void)
{
...
void
NrHelper1::EnableUlRxPhyTraces (void)
{
...
void
NrHelper1::EnableMacTraces (void)
{
  EnableDlMacTraces ();
  EnableUlMacTraces ();
}
...
void
NrHelper1::EnableDlMacTraces (void)
{
...
void
NrHelper1::EnableUlMacTraces (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
NrHelper1::EnableDlPhyTraces (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
NrHelper1::EnableUlPhyTraces (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
NrHelper1::GetRlcStats (void)
{
  return m_rlcStats;
}

void
NrHelper1::EnablePdcpTraces (void)
{
  NS_ASSERT_MSG (m_pdcpStats == 0, "please make sure that NrHelper1::EnablePdcpTraces is called at most once");
  m_pdcpStats = CreateObject<NrRadioBearerStatsCalculator> ("PDCP");
  m_radioBearerStatsConnector.EnablePdcpStats (m_pdcpStats);
}

Ptr<NrRadioBearerStatsCalculator>
NrHelper1::GetPdcpStats (void)
{
  return m_pdcpStats;
}
