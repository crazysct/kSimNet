callback_classes = [
    ...
    ['void', 'std::list<ns3::Ptr<ns3::NrControlMessage>, std::allocator<ns3::Ptr<ns3::NrControlMessage> > >', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'],
