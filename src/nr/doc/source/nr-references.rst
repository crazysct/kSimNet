...
.. [TS36413] 3GPP TS 36.413 "E-UTRAN N2 application protocol (N2AP)"
...
.. [FFAPI] FemtoForum `"NR MAC Scheduler Interface Specification v1.11"
   <http://www.smallcellforum.org/smallcellforum_resources/pdfsend05.php?file=NR%20MAC%20Scheduler%20Interface%20Specification.pdf>`_
...
.. [Sesia2009] S. Sesia, I. Toufik and M. Baker,
   "NR - The UMTS Long Term Evolution - from theory to practice",
   Wiley, 2009
...
.. [Piro2010] Giuseppe Piro, Luigi Alfredo Grieco, Gennaro Boggia, and Pietro Camarda,
   "A Two-level Scheduling Algorithm for QoS Support in the Downlink of NR Cellular Networks",
...
.. [Piro2011] G. Piro, N. Baldo. M. Miozzo, "An NR module for the ns-3 network simulator", 
...
.. [PaduaPEM] `"Ns-developers - NR error model contribution"
   <http://mailman.isi.edu/pipermail/ns-developers/2011-November/009559.html>`_

.. [ViennaNrSim] `"The Vienna NR Simulators"
   <http://www.nt.tuwien.ac.at/about-us/staff/josep-colom-ikuno/nr-simulators/>`_

.. [LozanoCost] Joan Olmos, Silvia Ruiz, Mario García-Lozano and David Martín-Sacristán,
   "Link Abstraction Models Based on Mutual Information for NR Downlink",
...
.. [Ikuno2010] J.C. Ikuno, M. Wrulich, M. Rupp, "System Level Simulation of NR Networks,"
   Vehicular Technology Conference (VTC 2010-Spring), 2010 IEEE 71st , vol., no., pp.1-5, 16-19 May 2010

.. [Milos2012] J. Milos, "Performance Analysis Of PCFICH NR Control Channel",
   Proceedings of the 19th Conference STUDENT EEICT 2012, Brno, CZ, 2012.

.. [FujitsuWhitePaper] "Enhancing NR Cell-Edge Performance via PDCCH ICIC".

.. [Bharucha2011] Z. Bharucha, G. Auer, T. Abe, N. Miki,
   "Femto-to-Macro Control Channel Interference Mitigation via Cell ID Manipulation in NR,"
   Vehicular Technology Conference (VTC Fall), 2011 IEEE , vol., no., pp.1-6, 5-8 Sept. 2011

.. [R4-081920] 3GPP R4-081920 `"NR PDCCH/PCFICH Demodulation Performance Results with Implementation Margin"
...
.. [FCapo2012] F.Capozzi, G.Piro, L.A. Grieco, G.Boggia, P.Camarda,
   "Downlink Packet Scheduling in NR Cellular Networks: Key Design Issues and a Survey",
...
.. [Dimou2009] K. Dimou, M. Wang, Y. Yang, M. Kazmi, A. Larmo, J. Pettersson, W. Muller, Y. Timner,
   "Handover within 3GPP NR: Design Principles and Performance",
...
.. [Lee2010] Y.J. Lee, B.J. Shin, J.C. Lim, D.H. Hong,
   "Effects of time-to-trigger parameter on handover performance in SON-based NR systems",
...
.. [Bbojovic2014] B. Bojovic, N. Baldo, `"A new Channel and QoS Aware
   Scheduler to enhance the capacity of Voice over NR systems"
   <http://www.cttc.es/publication/a-new-channel-and-qos-aware-scheduler-to-enhance-the-capacity-of-voice-over-nr-systems/>`_,
