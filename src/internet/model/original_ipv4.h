 ...
 */
#ifndef ORIGINAL_IPV4_H
#define ORIGINAL_IPV4_H
 ...
 * -# register a NetDevice for use by the Ipv41 layer (basically, to
...
public:
   ...
   */
  virtual uint32_t AddInterface (Ptr<NetDevice1> device) = 0;
   ...
   */
  virtual int32_t GetInterfaceForDevice (Ptr<const NetDevice1> device) const = 0;
   ...
   * 
   * \param interface Interface number of an Ipv41 interface
  ...
  virtual bool RemoveAddress (uint32_t interface, uint32_t addressIndex) = 0;
   ...
   /**
   * \brief Remove the given address on named Ipv41 interface
   *
   * \param interface Interface number of an Ipv41 interface
   ...
   */
  virtual Ipv4Address SelectSourceAddress (Ptr<const NetDevice1> device, 
                                           Ipv4Address dst, Ipv4InterfaceAddress::InterfaceAddressScope_e scope) = 0;

  /**
   * \param interface The interface number of an Ipv41 interface
  ...
  /**
   * \param interface Interface number of Ipv41 interface
   * \returns the Maximum Transmission Unit (in bytes) associated
   *          to the underlying Ipv41 interface
   */
   ...
   * considered valid during Ipv41 forwarding.
   */
   ...
   * ignored during Ipv41 forwarding.
   */
...
private:
  // Indirect the Ipv41 attributes through private pure virtual methods
