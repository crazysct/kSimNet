 ...
 */
#ifndef ORIGINAL_LOOPBACK_NET_DEVICE_H
#define ORIGINAL_LOOPBACK_NET_DEVICE_H
 ...
 */
class LoopbackNetDevice1 : public NetDevice1
{
public:
  /**
  ...
  virtual Ptr<Channel1> GetChannel (void) const; //sjkang_x
...
private:
   ...
   */
  NetDevice1::ReceiveCallback m_rxCallback;

  /**
   * The callback used to notify higher layers that a packet has been received in promiscuous mode.
   */
  NetDevice1::PromiscReceiveCallback m_promiscCallback;
