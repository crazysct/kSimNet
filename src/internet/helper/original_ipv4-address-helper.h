...
#ifndef ORIGINAL_IPV4_ADDRESS_HELPER_H
#define ORIGINAL_IPV4_ADDRESS_HELPER_H

#include "ns3/ipv4-address.h"
#include "ns3/original_net-device-container.h"
#include "ns3/original_ipv4-interface-container.h"
 ...
 */
  Ipv4AddressHelper1 (Ipv4Address network, Ipv4Mask mask, 
 ...
 *
 * @param c The NetDeviceContainer1 holding the collection of net devices we
 ...
 * @see NewNetwork
 */
  Ipv4InterfaceContainer1 Assign (const NetDeviceContainer1 &c);
