...
#ifndef ORIGINAL_IPV4_INTERFACE_CONTAINER_H
#define ORIGINAL_IPV4_INTERFACE_CONTAINER_H
 ...
 * @see Ipv4
 */
class Ipv4InterfaceContainer1 
{
public:
  /**
   * \brief Container Const Iterator for pairs of Ipv4 smart pointer / Interface Index.
   */
  typedef std::vector<std::pair<Ptr<Ipv41>, uint32_t> >::const_iterator Iterator;
   ...
   */
  void Add (const Ipv4InterfaceContainer1& other);
   ...
   */
  void Add (Ptr<Ipv41> ipv4, uint32_t interface);
   ...
   */
  void Add (std::pair<Ptr<Ipv41>, uint32_t> ipInterfacePair);
   ...
   * \endcode
   */
  std::pair<Ptr<Ipv41>, uint32_t> Get (uint32_t i) const;

private:
  /**
   * \brief Container for pairs of Ipv4 smart pointer / Interface Index.
   */
  typedef std::vector<std::pair<Ptr<Ipv41>,uint32_t> > InterfaceVector;
