...
#ifndef ORIGINAL_EPC_ENB_APPLICATION_H
#define ORIGINAL_EPC_ENB_APPLICATION_H
 ...
 */
class EpcEnbApplication1 : public Application
{

  friend class MemberEpcEnbS1SapProvider<EpcEnbApplication1>;
  friend class MemberEpcS1apSapEnb<EpcEnbApplication1>;
...
public:
   ...
   * 
   */
  virtual ~EpcEnbApplication1 (void);
