...
NS_OBJECT_ENSURE_REGISTERED(EpcX2AssistantInfoHeader); //sjkang1114
EpcX2AssistantInfoHeader::EpcX2AssistantInfoHeader(){
...
TypeId
EpcX2AssistantInfoHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::EpcX2AssistantInfoHeader")
    .SetParent<Header> ()
    .SetGroupName("Lte")
    .AddConstructor<EpcX2AssistantInfoHeader> ()
  ;
  return tid;
}
TypeId
EpcX2AssistantInfoHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
uint32_t
EpcX2AssistantInfoHeader::GetSerializedSize()const{
return headerLength;
}
void
EpcX2AssistantInfoHeader::Serialize(Buffer::Iterator start)const {
	Buffer::Iterator i = start;
...
uint32_t
EpcX2AssistantInfoHeader::Deserialize(Buffer::Iterator start){
	Buffer::Iterator i =start;
...
void
EpcX2AssistantInfoHeader::Print(std::ostream &os) const
{
...
uint32_t
EpcX2AssistantInfoHeader::GetTxonQueue()const{
	return TxonQueueSize;
}
void
EpcX2AssistantInfoHeader::SetTxonQueue(uint32_t txq){
	TxonQueueSize=txq;
}
uint32_t
EpcX2AssistantInfoHeader::GetRetxQueue()const{
	return RetxQueueSize;
}
void
EpcX2AssistantInfoHeader::SetRetxQueue(uint32_t retxq){
	RetxQueueSize=retxq;
}
uint32_t
EpcX2AssistantInfoHeader::GetTxedQueue()const{
	return TxedQueueSize;
}
void
EpcX2AssistantInfoHeader::SetTxedQueue(uint32_t txedq){
	TxedQueueSize=txedq;
}
uint32_t
EpcX2AssistantInfoHeader::GetTxonQueingDelay() const {
	return TxQueingDelay;
}
void
EpcX2AssistantInfoHeader::SetTxonQueingDelay(uint32_t ququingdelay){
	TxQueingDelay = ququingdelay;
}
uint32_t
EpcX2AssistantInfoHeader::GetReTxQueuingDelay() const {
	return ReTxQueingDelay;
}
void
EpcX2AssistantInfoHeader::SetReTxQueingDelay(uint32_t retxququingdelay){
	ReTxQueingDelay = retxququingdelay;
}
uint8_t
EpcX2AssistantInfoHeader::GetSourceCellId() const {
	return sourceCellId;
}
void
EpcX2AssistantInfoHeader::SetSourceCellId(uint8_t cellId){
	sourceCellId = cellId;
}
void
EpcX2AssistantInfoHeader::SetRnti(uint8_t rnti){
	this->rnti =rnti;
}
uint8_t
EpcX2AssistantInfoHeader::GetRnti(){
	return rnti;
}
void
EpcX2AssistantInfoHeader::SetDrbId(uint8_t drbId){
	this->drbId = drbId;
}
uint8_t
EpcX2AssistantInfoHeader::GetDrbId(){
	return drbId;
}
uint16_t
EpcX2AssistantInfoHeader::GetNumbefOfIes(){
	return 8;
}
/////////////////////////////////////////////////////////////////////
...
EpcX2HandoverRequestHeader::Serialize (Buffer::Iterator start) const
{
 ...
 // i.WriteU8(m_lteCellId); //sjkang0416
}
...
EpcX2HandoverRequestHeader::Print (std::ostream &os) const
{
  ...
  os << " isMc = " << m_isMc;
  os << "isMc_2 =" << m_isMc_2;
  //os<<"lte cell ID" << m_lteCellId; //sjkang
...
bool
EpcX2HandoverRequestHeader::GetIsMc_2 () const
{
  return m_isMc_2;
}

void
EpcX2HandoverRequestHeader::SetIsMc_2 (bool isMc)
{
  m_isMc_2 = isMc;
}
uint16_t
...
uint16_t
EpcX2McHandoverHeader::GetSecondMmWaveCellId() const
{
	return m_secondMmWaveCellId;
}
void
EpcX2McHandoverHeader::SetSecondMmWaveCellId(uint16_t secondID){
...
bool
EpcX2SecondaryCellHandoverCompletedHeader::GetisMc(void) const{
	return m_isMc;
}
bool
EpcX2SecondaryCellHandoverCompletedHeader::GetisMc_2(void) const{
	return m_isMc_2;
}
uint32_t
...
void
EpcX2SecondaryCellHandoverCompletedHeader::SetisMc(bool isMc)  //sjkang0710
{
	m_isMc = isMc;
}
void
EpcX2SecondaryCellHandoverCompletedHeader::SetisMc_2(bool isMc_2) //sjkang0710
{
	m_isMc_2 = isMc_2;
}
uint64_t
...
///////////////////////////////////////////////////////////
NS_OBJECT_ENSURE_REGISTERED(EpcX2DuplicationRlcBufferHeader);
EpcX2DuplicationRlcBufferHeader::EpcX2DuplicationRlcBufferHeader()
    :m_numberOfIes(4),
	 m_headerLength(7),
	 m_imsi(0),
	 m_targetCellID(0),
...
TypeId
EpcX2DuplicationRlcBufferHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::EpcX2DuplicationRlcBufferHeader")
    .SetParent<Header> ()
    .SetGroupName("Lte")
    .AddConstructor<EpcX2DuplicationRlcBufferHeader> ()
  ;
  return tid;
}
TypeId
EpcX2DuplicationRlcBufferHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}
void
EpcX2DuplicationRlcBufferHeader::SetImsi(uint16_t imsi){
	m_imsi  = imsi;
}
uint16_t
EpcX2DuplicationRlcBufferHeader::GetImsi() const {
	return m_imsi;
}
void
EpcX2DuplicationRlcBufferHeader::SetTargetCellID(uint16_t targetCellID){
	m_targetCellID = targetCellID;
}
uint16_t
EpcX2DuplicationRlcBufferHeader::GetTargetCellID() const {
	return m_targetCellID;
}
void
EpcX2DuplicationRlcBufferHeader::SetCellIDForBufferForwarding(uint16_t cellIDforBufferForwarding){
	m_cellIDforBufferForwarding = cellIDforBufferForwarding;
}
uint16_t
EpcX2DuplicationRlcBufferHeader::GetCellIDForBufferForwarding() const {
	return m_cellIDforBufferForwarding;
}
bool
EpcX2DuplicationRlcBufferHeader::GetOption() const{
	return m_option;
}
void
EpcX2DuplicationRlcBufferHeader::SetOption(bool option){
	m_option = option;
}
void
EpcX2DuplicationRlcBufferHeader::Serialize(Buffer::Iterator start) const{
	 Buffer::Iterator i = start;
...
uint32_t
EpcX2DuplicationRlcBufferHeader::Deserialize(Buffer::Iterator start){
	 Buffer::Iterator i = start;
...
uint32_t
EpcX2DuplicationRlcBufferHeader::GetSerializedSize (void) const
{
  return m_headerLength;
}
void
EpcX2DuplicationRlcBufferHeader::Print (std::ostream &os) const
{
  os << " imsi = " << m_imsi;
...
uint32_t
EpcX2DuplicationRlcBufferHeader::GetLengthOfIes () const
{
  return m_headerLength;
}

uint32_t
EpcX2DuplicationRlcBufferHeader::GetNumberOfIes () const
{
  return m_numberOfIes;
}
/////////////////////////////////////////////////////////////////////
...
void
EpcX2UeImsiSinrUpdateHeader::SetRnti(uint16_t rnti){ //sjkang
	m_rnti = rnti;
}
uint16_t 
