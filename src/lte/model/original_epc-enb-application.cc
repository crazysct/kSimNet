...
#include "original_epc-enb-application.h"
#include "ns3/log.h"
...
NS_LOG_COMPONENT_DEFINE ("EpcEnbApplication1");

EpcEnbApplication1::EpsFlowId_t::EpsFlowId_t ()
{
}

EpcEnbApplication1::EpsFlowId_t::EpsFlowId_t (const uint16_t a, const uint8_t b)
  : m_rnti (a),
    m_bid (b)
{
}
...
bool
operator == (const EpcEnbApplication1::EpsFlowId_t &a, const EpcEnbApplication1::EpsFlowId_t &b)
{
...
TypeId
EpcEnbApplication1::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::EpcEnbApplication1")
    .SetParent<Object> ()
    .SetGroupName("Lte");
  return tid;
}
...
void
EpcEnbApplication1::DoDispose (void)
{
...
EpcEnbApplication1::EpcEnbApplication1 (Ptr<Socket> lteSocket, Ptr<Socket> s1uSocket, Ipv4Address enbS1uAddress, Ipv4Address sgwS1uAddress, uint16_t cellId)
    ...
    m_cellId (cellId)
{
  ...
  m_s1uSocket->SetRecvCallback (MakeCallback (&EpcEnbApplication1::RecvFromS1uSocket, this));
  m_lteSocket->SetRecvCallback (MakeCallback (&EpcEnbApplication1::RecvFromLteSocket, this));
  m_s1SapProvider = new MemberEpcEnbS1SapProvider<EpcEnbApplication1> (this);
  m_s1apSapEnb = new MemberEpcS1apSapEnb<EpcEnbApplication1> (this);
}


EpcEnbApplication1::~EpcEnbApplication1 (void)
{
  NS_LOG_FUNCTION (this);
}
...
void 
EpcEnbApplication1::SetS1SapUser (EpcEnbS1SapUser * s)
{
  m_s1SapUser = s;
}
...
EpcEnbS1SapProvider* 
EpcEnbApplication1::GetS1SapProvider ()
{
  return m_s1SapProvider;
}

void 
EpcEnbApplication1::SetS1apSapMme (EpcS1apSapMme * s)
{
  m_s1apSapMme = s;
}
...
EpcS1apSapEnb* 
EpcEnbApplication1::GetS1apSapEnb ()
{
  return m_s1apSapEnb;
}

void 
EpcEnbApplication1::DoInitialUeMessage (uint64_t imsi, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void 
EpcEnbApplication1::DoPathSwitchRequest (EpcEnbS1SapProvider::PathSwitchRequestParameters params)
{
  NS_LOG_FUNCTION (this);
...
void 
EpcEnbApplication1::DoUeContextRelease (uint16_t rnti)
{
...
void 
EpcEnbApplication1::DoInitialContextSetupRequest (uint64_t mmeUeS1Id, uint16_t enbUeS1Id, std::list<EpcS1apSapEnb::ErabToBeSetupItem> erabToBeSetupList)
{
  NS_LOG_FUNCTION (this);
...
void 
EpcEnbApplication1::DoPathSwitchRequestAcknowledge (uint64_t enbUeS1Id, uint64_t mmeUeS1Id, uint16_t gci, std::list<EpcS1apSapEnb::ErabSwitchedInUplinkItem> erabToBeSwitchedInUplinkList)
{
  NS_LOG_FUNCTION (this);
...
void 
EpcEnbApplication1::RecvFromLteSocket (Ptr<Socket> socket)
{
  NS_LOG_FUNCTION (this);  
...
void 
EpcEnbApplication1::RecvFromS1uSocket (Ptr<Socket> socket)
{
...
void 
EpcEnbApplication1::SendToLteSocket (Ptr<Packet> packet, uint16_t rnti, uint8_t bid)
{
...
void 
EpcEnbApplication1::SendToS1uSocket (Ptr<Packet> packet, uint32_t teid)
{
...
void
EpcEnbApplication1::DoReleaseIndication (uint64_t imsi, uint16_t rnti, uint8_t bearerId)
{
