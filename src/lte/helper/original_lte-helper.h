...
#ifndef ORIGINAL_LTE_HELPER_H
#define ORIGINAL_LTE_HELPER_H
 ...
 * \ingroup lte
 *
 * Creation and configuration of LTE entities. One LteHelper1 instance is
 * typically enough for an LTE simulation. To create it:
 *
 *     Ptr<LteHelper1> lteHelper = CreateObject<LteHelper1> ();
 *
...
public:
   ...
   * 
   * \sa LteHelper1::Attach(NetDeviceContainer1 ueDevices);
   */
   ...
   * instead of this function.
   *
   * \sa LteHelper1::Attach(Ptr<NetDevice> ueDevice);
   */
