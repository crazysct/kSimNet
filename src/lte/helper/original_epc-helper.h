...
#ifndef ORIGINAL_EPC_HELPER_H
#define ORIGINAL_EPC_HELPER_H
...
#include <ns3/original_net-device-container.h> //dhson
namespace ns3 {
 ...
 * and connect them. 
 */
class EpcHelper1 : public Object
{
public:
   ...
   */
  virtual void AddEnb (Ptr<Node> enbNode, Ptr<NetDevice1> lteEnbNetDevice, uint16_t cellId) = 0;
   ...
   */
  virtual void AddUe (Ptr<NetDevice1> ueLteDevice, uint64_t imsi) = 0;
   ...
   */
  virtual uint8_t ActivateEpsBearer (Ptr<NetDevice1> ueLteDevice, uint64_t imsi, Ptr<EpcTft> tft, EpsBearer bearer) = 0;
   ...
   * \param bearer struct describing the characteristics of the EPS bearer to be activated
   */
  virtual uint8_t ActivateEpsBearer (Ptr<NetDevice1> ueLteDevice, Ptr<EpcUeNas> ueNas, uint64_t imsi, Ptr<EpcTft> tft, EpsBearer bearer) = 0 ;//sjkang
   ...
   */
  virtual Ipv4InterfaceContainer AssignUeIpv4Address (NetDeviceContainer1 ueDevices) = 0;
