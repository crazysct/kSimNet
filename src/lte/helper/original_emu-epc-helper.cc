...
#include "original_emu-epc-helper.h"
#include <ns3/log.h>
...
NS_LOG_COMPONENT_DEFINE ("EmuEpcHelper1");

NS_OBJECT_ENSURE_REGISTERED (EmuEpcHelper1);


EmuEpcHelper1::EmuEpcHelper1 () 
...
TypeId
EmuEpcHelper1::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::EmuEpcHelper1")
    ...
    .AddAttribute ("EnbMacAddressBase", 
                   ...
                   MakeStringAccessor (&EmuEpcHelper1::m_enbMacAddressBase),
                   MakeStringChecker ())
    ;
  return tid;
}
...
EmuEpcHelper1::DoInitialize ()
{
  ...
  EpcHelper1::DoInitialize ();
}

void
EmuEpcHelper1::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
void
EmuEpcHelper1::AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId)
{
...
void
EmuEpcHelper1::AddX2Interface (Ptr<Node> enb1, Ptr<Node> enb2)
{
...
void 
EmuEpcHelper1::AddUe (Ptr<NetDevice> ueDevice, uint64_t imsi)
{
...
uint8_t
EmuEpcHelper1::ActivateEpsBearer (Ptr<NetDevice> ueDevice, uint64_t imsi, Ptr<EpcTft> tft, EpsBearer bearer)
{
...
EmuEpcHelper1::AssignUeIpv4Address (NetDeviceContainer ueDevices)
{
