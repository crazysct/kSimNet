 ...
 *
 * A VirtualNetDevice1 is a "virtual" NetDevice implementation which
 ...
 * VirtualNetDevice1.  Together, these features allow one to build tunnels.
 ...
 * directly.  However, VirtualNetDevice1 is usually much simpler to program
 * than a NetDevice subclass.
 */
class VirtualNetDevice1 : public NetDevice1
{
public:
  /**
   * Callback the be invoked when the VirtualNetDevice1 is asked to queue/transmit a packet.
  ...
  virtual Ptr<Channel1> GetChannel (void) const;
  ...
  virtual void SetReceiveCallback (NetDevice1::ReceiveCallback cb);
  virtual void SetPromiscReceiveCallback (NetDevice1::PromiscReceiveCallback cb);
   ...
   */
  virtual void SetOpenFlowReceiveCallback (NetDevice1::PromiscReceiveCallback cb);
...
private:
  ...
  NetDevice1::PromiscReceiveCallback m_openFlowRxCallback;
};
