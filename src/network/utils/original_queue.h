...
#ifndef ORIGINAL_QUEUE_H
#define ORIGINAL_QUEUE_H

#include "ns3/packet.h"
#include "ns3/object.h"
#include "ns3/traced-callback.h"
#include "ns3/original_net-device.h" // jhlim
#include "ns3/queue-item.h" //jhlim
//#include "ns3/net-device-queue-interface.h" //jhlim
...
public:
   ...
   */
  void SetMode (Queue1::QueueMode mode);
   ...
   */
  Queue1::QueueMode GetMode (void) const;
