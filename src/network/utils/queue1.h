...
public:
  ...
  //void Drop (Ptr<Item> item); // jhlim
  void Drop (Ptr<Item> item, int dummy); // jhlim: for QueueItem

  /* jhlim for QueueItem*/
  bool DoEnqueue (Ptr<Item> item, int dummy);
  Ptr<Item> DoDequeue (int dummy);
  Ptr<Item> DoRemove (int dummy);
  Ptr<const Item> DoPeek (int dummy) const;
   ...
   */
  bool Enqueue (Ptr<Item> item); // jhlim: remove virtual
  bool Enqueue (Ptr<Item> item, int dummy); // jhlim: for QueueItem
   ...
   */
  Ptr<Item> Dequeue (void); // jhlim:: remove virtual
  Ptr<Item> Dequeue (int dummy); // jhlim: for QueueItem
   ...
   * \return 0 if the operation was not successful; the item otherwise.
   */
  Ptr<Item>  Remove (void); // jhlim: remove virtual
  Ptr<Item>  Remove (int dummy); // jhlim: for QueueItem
   ...
   * \return 0 if the operation was not successful; the item otherwise.
   */
  Ptr<const Item> Peek (void); // jhlim: remove virtual
  Ptr<const Item> Peek (int dummy) const; // jhlim: for QueueItem


  /* jhlim: for QueueItem*/
  void NotifyDrop (Ptr<Item> item, int dummy);
  typedef Callback<void, Ptr<Item> > DropCallback;
