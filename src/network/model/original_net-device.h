 ...
 */
#ifndef ORIGINAL_NET_DEVICE_H
#define ORIGINAL_NET_DEVICE_H
 ...
 * information.
 */
class QueueItem : public SimpleRefCount<QueueItem> // jhlim 1x
{
public:
  /**
 ...
 */
class NetDeviceQueue1 : public SimpleRefCount<NetDeviceQueue1>
{
public:
  NetDeviceQueue1 ();
  virtual ~NetDeviceQueue1();
 ...
 */
class NetDeviceQueueInterface1 : public Object
{
public:
  /**
   ...
   */
  NetDeviceQueueInterface1 ();
  virtual ~NetDeviceQueueInterface1 ();
   ...
   */
  Ptr<NetDeviceQueue1> GetTxQueue (uint8_t i) const;
...
private:
  std::vector< Ptr<NetDeviceQueue1> > m_txQueuesVector;   //!< Device transmission queues
 ...
 *     the device queue
 */
class NetDevice1 : public Object
{
public:
  /**
   * \brief Get the type ID.
   ...
   */
  virtual Ptr<Channel1> GetChannel (void) const = 0;
   ...
   *          otherwise.
   */
  typedef Callback< bool, Ptr<NetDevice1>, Ptr<const Packet>, uint16_t, const Address & > ReceiveCallback;
   ...
   *          otherwise.
   */
  typedef Callback< bool, Ptr<NetDevice1>, Ptr<const Packet>, uint16_t,
