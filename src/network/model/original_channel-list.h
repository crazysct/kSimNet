...
#ifndef ORIGINAL_CHANNEL_LIST_H
#define ORIGINAL_CHANNEL_LIST_H
 ...
 */
class ChannelList1 //sjkang_x
{
public:
  /// Channel container iterator
  typedef std::vector< Ptr<Channel1> >::const_iterator Iterator;
   ...
   */
  static uint32_t Add (Ptr<Channel1> channel);
  /**
   ...
   */
  static Ptr<Channel1> GetChannel (uint32_t n);
  /**
