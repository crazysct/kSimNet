 ...
 * PointToPoint links. 
 */
class OvsPointToPointEpcHelper : public EpcHelper
{
public:
  ...
  virtual void AddEnbOvs (Ptr<Node> enbNode, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId, int n_sw);
...
private:
  ...
  Ipv4AddressHelper m_s1uIpv4AddressHelper_ovs_c; 
